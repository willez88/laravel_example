...
class MunicipalitySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::transaction(function () use ($permissions, $estatesMunicipalities) {
            foreach ($estatesMunicipalities as $codeEstate => $municipalities) {
