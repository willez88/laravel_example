...
class ParishSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::transaction(function () use ($permissions, $municipalitiesParishes) {
            foreach ($municipalitiesParishes as $codeMunicipality => $parishes) {
                $mun = Municipality::where('code', $codeMunicipality)->first();
